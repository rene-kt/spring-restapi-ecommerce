...
public class JWTAuthenticationFilterSeller extends UsernamePasswordAuthenticationFilter {
    ...
    public JWTAuthenticationFilterSeller(AuthenticationManager authenticationManager, JWTUtil jwtUtil) {
    ...
    protected void successfulAuthentication(HttpServletRequest req,
        ...
        String username = ((SellerSS) auth.getPrincipal()).getUsername();
